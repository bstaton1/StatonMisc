...
#' random variable to the lognormal standard deviation, using a simple transformation
#'
#' @param cv a numeric vector, possibly length > 1, containing the CV to convert
#'
