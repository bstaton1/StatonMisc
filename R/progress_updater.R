#' Print a progress indicator to console
#'
#' Include this function in a loop or other calculation that iterates over elements
#' in which the total number of elements is known to obtain an indication of what percentage
#' of the calculation is completed
#'
...
#' @param rnd numeric vector of length == 1. Controls the number of decimal values in the printed percent.
...
progress_updater = function(i, n, grp = NULL, rnd = 0) {
  # clear the last printed line
  cat("\r                                              ")
  # print the progress for this line
  cat("\r", round(i/n, rnd+2) * 100, "%", ifelse(!is.null(grp), paste0(" (", grp, ")"), ""), sep = "")
